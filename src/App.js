...
import FilmsList from "./compoinents/FilmsList";
import Navbarr from "./compoinents/Navbarr";
...
function App() {
  const [films, setfilms] = useState([
    ...
    },
    {
      name: "Paper Lives",
      posterurl:
        "https://th.bing.com/th/id/OIP.BgVg_OI8XVqMNeRmVH4I7AHaJQ?w=139&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7",
      description:
    ...
    },
    {
      name: "The Circle",
      posterurl:
        "https://th.bing.com/th/id/OIP.PRR1EYI_prFEkslO2DcZgQHaLH?pid=ImgDet&w=184&h=276&c=7&dpr=1.3",
      description:
